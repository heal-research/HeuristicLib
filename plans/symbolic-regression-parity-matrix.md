...
| Evolvable-constant optimization | Levenberg-Marquardt numeric parameter fitting | Reusable differentiation, numerical optimization, and refinement composition | Direct parameter fitter implemented; refiner and algorithm integration implemented and hardened | The implementation and remaining integration stages are specified in `symbolic-regression-parameter-fitting-plan.md`. |
