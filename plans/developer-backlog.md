...
- reduce the generic arity a user has to name, per [generic-arity-usability.md](generic-arity-usability.md), with the migration itself planned in [configuration-arity-migration.md](configuration-arity-migration.md). The first holds the measurements and the settled decisions; the second holds the ordered migration
