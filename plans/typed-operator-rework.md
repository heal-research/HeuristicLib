...
- Interceptor and Terminator have not yet completed the same migration and acceptance process. Shared changes such as adopting `ValueArray<T>` do not by themselves mark a role complete.
