...
For implementation rules, public API conventions and contributor decisions, see [Developer guidelines](/contributing/developer-guidelines). Repository workflow and validation commands live in `AGENTS.md`.
