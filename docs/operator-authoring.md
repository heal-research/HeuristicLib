...
Generating these families at build time was evaluated and declined; the [developer backlog](developer-backlog.md#generated-operator-families) records the reasoning.
