...
public class AlgorithmInterfaceCapabilityTests
{
    ...
    [InlineData("held.WithMaxIterations(10)")]
    [InlineData("held.WithTerminator(new NeverTerminator<Permutation>())")]
    [InlineData("held.WithMaxAlgorithmDuration(TimeSpan.FromSeconds(1))")]
