...
public class SpecialProblem(double data) : SingleSolutionProblem<SpecialProblem, SpecialGenotype, SpecialSearchSpace>(SingleObjective.Maximize, GeTSearchSpace())
{
