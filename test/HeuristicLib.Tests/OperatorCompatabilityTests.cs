  ...
  where TProblem : class, IProblem<TGenotype, TEncoding>
{
  ...
  public override AlgorithmResult<TGenotype> Execute(TProblem problem, IRandomNumberGenerator? random = null) => throw new NotImplementedException();
}
  ...
  where TProblem : class, IProblem<Permutation, PermutationEncoding>
{
  ...
  public override AlgorithmResult<Permutation> Execute(TProblem problem, IRandomNumberGenerator? random = null) => throw new NotImplementedException();
}
...
public class TravelingSalesmanProblemSpecificAlgorithm : Algorithm<Permutation, PermutationEncoding, TravelingSalesmanProblem, AlgorithmResult<Permutation>>
{
  ...
  public override AlgorithmResult<Permutation> Execute(TravelingSalesmanProblem problem, IRandomNumberGenerator? random = null) => throw new NotImplementedException();
}
  ...
  where TProblem : class, IProblem<RealVector, RealVectorEncoding>
{
  ...
  public override AlgorithmResult<RealVector> Execute(TProblem problem, IRandomNumberGenerator? random = null) => throw new NotImplementedException();
}
...
public class TestFunctionProblemSpecificAlgorithm : Algorithm<RealVector, RealVectorEncoding, TestFunctionProblem, AlgorithmResult<RealVector>>
{
  ...
  public override AlgorithmResult<RealVector> Execute(TestFunctionProblem problem, IRandomNumberGenerator? random = null) => throw new NotImplementedException();
}
