...
//   //     randomSeed: 42,
//   //     terminator: Terminator.OnGeneration<PopulationIterationState<RealVector>>(3)
//   //   );
//   //   
...
//   //     replacer: new ElitismReplacer(1), 
//   //     randomSeed: 42,
//   //     terminator: Terminator.OnGeneration<PopulationIterationState<RealVector>>(4)
//   //   );
//   //
//   //   var concatAlgorithm = new ConcatAlgorithm<RealVector, RealVectorSearchSpace, GeneticAlgorithmState<RealVector>, PopulationIterationState<RealVector>>([ga1, ga2, ga3]);
//   //
...
//   //     mutationRate: 0.1,
//   //     DirectEvaluator: DirectEvaluator,
...
//   //   public PopulationState<RealVector> AfterInterception(EvolutionStrategyPopulationState sourceState, PopulationState<RealVector>? previousTargetState = null) {
