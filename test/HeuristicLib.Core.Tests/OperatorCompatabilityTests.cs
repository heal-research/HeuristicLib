...
public class OperatorCompatabilityTests
{
  ...
  public void F()
  {
    var a = new IndependentAlgorithm<Permutation, PermutationSearchSpace>();
...
public abstract record AlgorithmResult : IAlgorithmState;

public class IndependentAlgorithm<TGenotype, TSearchSpace, TProblem> : Algorithm<TGenotype, TSearchSpace, TProblem, AlgorithmResult>
  where TSearchSpace : class, ISearchSpace<TGenotype>
  where TProblem : class, IProblem<TGenotype, TSearchSpace>
{
  public ICrossover<TGenotype, TSearchSpace, TProblem> Crossover { get; set; }

  public override AlgorithmResult Execute(TProblem problem, TSearchSpace? searchSpace = null, IRandomNumberGenerator? random = null) => throw new NotImplementedException();
}
...
public class PermutationEncodingSpecificAlgorithm<TProblem> : Algorithm<Permutation, PermutationSearchSpace, TProblem, AlgorithmResult>
  where TProblem : class, IProblem<Permutation, PermutationSearchSpace>
{
  ...
  public override AlgorithmResult Execute(TProblem problem, PermutationSearchSpace? searchSpace = null, IRandomNumberGenerator? random = null) => throw new NotImplementedException();
}
...
public class TravelingSalesmanProblemSpecificAlgorithm : Algorithm<Permutation, PermutationSearchSpace, TravelingSalesmanProblem, AlgorithmResult>
{
  public ICrossover<Permutation, PermutationSearchSpace, TravelingSalesmanProblem> Crossover { get; set; }

  public override AlgorithmResult Execute(TravelingSalesmanProblem problem, PermutationSearchSpace? searchSpace = null, IRandomNumberGenerator? random = null) => throw new NotImplementedException();
}

public class RealVectorEncodingSpecificAlgorithm<TProblem> : Algorithm<RealVector, RealVectorSearchSpace, TProblem, AlgorithmResult>
  where TProblem : class, IProblem<RealVector, RealVectorSearchSpace>
{
  ...
  public override AlgorithmResult Execute(TProblem problem, RealVectorSearchSpace? searchSpace = null, IRandomNumberGenerator? random = null) => throw new NotImplementedException();
}
...
public class TestFunctionProblemSpecificAlgorithm : Algorithm<RealVector, RealVectorSearchSpace, TestFunctionProblem, AlgorithmResult>
{
  public ICrossover<RealVector, RealVectorSearchSpace, TestFunctionProblem> Crossover { get; set; }

  public override AlgorithmResult Execute(TestFunctionProblem problem, RealVectorSearchSpace? searchSpace = null, IRandomNumberGenerator? random = null) => throw new NotImplementedException();
}
