...
public class RandomNumberGenerator : IRandomNumberGenerator {
  ...
  public static IRandomNumberGenerator Create(ulong seed) {
    return Create(seed, RandomProfile.Default);
  }

  public static IRandomNumberGenerator Create(ulong seed, RandomProfile profile) {
    return new RandomNumberGenerator(seed, profile.KeyCombiner, profile.EngineFactory);
  }

  public IRandomNumberGenerator Fork(ulong forkKey) {
    ulong combinedKey = keyCombiner.Combine(key, forkKey);
