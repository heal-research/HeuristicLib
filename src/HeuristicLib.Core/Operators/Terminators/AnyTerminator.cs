  ...
  where TProblem : class, IProblem<TGenotype, TSearchSpace>
{
  ...
  public override bool ShouldTerminate(TIterationResult currentIterationState, TIterationResult? previousIterationState, TSearchSpace encoding, TProblem problem) => Terminators.Any(criterion => criterion.ShouldTerminate(currentIterationState, previousIterationState, encoding, problem));
}
