...
public class GrowTreeCreator : SymbolicExpressionTreeCreator
{
  ...
  private static SymbolicExpressionTree CreateTree(IRandomNumberGenerator random, SymbolicExpressionSearchSpace encoding)
  {
  ...
  public static void Create(IRandomNumberGenerator random, SymbolicExpressionTreeNode seedNode, int maxDepth, SymbolicExpressionSearchSpace encoding)
  {
  ...
  private static void RecursiveCreate(IRandomNumberGenerator random, SymbolicExpressionTreeNode root, int currentDepth, int maxDepth, SymbolicExpressionSearchSpace encoding, IReadOnlyCollection<Symbol> allowedSymbols)
  {
  ...
  private static int SampleArity(IRandomNumberGenerator random, SymbolicExpressionTreeNode node, SymbolicExpressionSearchSpace encoding)
  {
