...
public class AnyTerminator<TGenotype, TIterationResult, TEncoding, TProblem>(params IReadOnlyList<ITerminator<TGenotype, TIterationResult, TEncoding, TProblem>> terminators)
