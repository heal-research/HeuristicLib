...
public sealed class MultiSymbolicExpressionTreeManipulator : SymbolicExpressionTreeManipulator
{
  ...
  public override SymbolicExpressionTree Mutate(SymbolicExpressionTree parent, IRandomNumberGenerator random, SymbolicExpressionSearchSpace encoding) => SubOperators.SampleRandom(random).Mutate(parent, random, encoding);
}
