...
public sealed class OnePointShaker : SymbolicExpressionTreeManipulator
{
  ...
  public override SymbolicExpressionTree Mutate(SymbolicExpressionTree parent, IRandomNumberGenerator random, SymbolicExpressionSearchSpace encoding) => Shake(random, parent, ShakingFactor);
}
