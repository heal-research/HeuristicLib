  ...
  where TProblem : class, IProblem<TGenotype, TSearchSpace>
{
  ...
  IReadOnlyList<TGenotype> IOperator<IReadOnlyList<TGenotype>, IOptimizationContext<TGenotype, TSearchSpace, TProblem>, IReadOnlyList<TGenotype>>.Apply(IReadOnlyList<TGenotype> input, IOptimizationContext<TGenotype, TSearchSpace, TProblem> context)
  {
  ...
  where TSearchSpace : class, ISearchSpace<TGenotype>
{
  ...
  IReadOnlyList<TGenotype> IOperator<IReadOnlyList<TGenotype>, IOptimizationContext<TGenotype, TSearchSpace, IProblem<TGenotype, TSearchSpace>>, IReadOnlyList<TGenotype>>.Apply(IReadOnlyList<TGenotype> input, IOptimizationContext<TGenotype, TSearchSpace, IProblem<TGenotype, TSearchSpace>> context) =>
...
public abstract class Mutator<TGenotype> : IMutator<TGenotype, ISearchSpace<TGenotype>, IProblem<TGenotype, ISearchSpace<TGenotype>>>
{
  ...
  IReadOnlyList<TGenotype> IOperator<IReadOnlyList<TGenotype>, IOptimizationContext<TGenotype, ISearchSpace<TGenotype>, IProblem<TGenotype, ISearchSpace<TGenotype>>>, IReadOnlyList<TGenotype>>.Apply(IReadOnlyList<TGenotype> input, IOptimizationContext<TGenotype, ISearchSpace<TGenotype>, IProblem<TGenotype, ISearchSpace<TGenotype>>> context) => 
  ...
  where TP : class, IProblem<TG, TS>
{
  ...
  public override IReadOnlyList<TG> Mutate(IReadOnlyList<TG> parent, IRandomNumberGenerator random, TS searchSpace, TP problem)
  {
    ...
    return @operator.Apply(parent, context);
  }
}
