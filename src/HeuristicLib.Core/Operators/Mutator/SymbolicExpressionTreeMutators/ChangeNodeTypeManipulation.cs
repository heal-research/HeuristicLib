...
public class ChangeNodeTypeManipulation : SymbolicExpressionTreeManipulator {
  ...
  public static SymbolicExpressionTree ChangeNodeType(SymbolicExpressionTree symbolicExpressionTree, IRandomNumberGenerator random, SymbolicExpressionSearchSpace encoding) {
