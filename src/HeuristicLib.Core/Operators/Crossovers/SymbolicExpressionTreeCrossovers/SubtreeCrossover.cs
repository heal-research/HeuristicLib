...
public class SubtreeCrossover : SymbolicExpressionTreeCrossover
{
  ...
  public static SymbolicExpressionTree Cross(IRandomNumberGenerator random,
    ...
    double internalCrossoverPointProbability, SymbolicExpressionSearchSpace encoding)
  {
  ...
  private static void SelectCrossoverPoint(IRandomNumberGenerator random, SymbolicExpressionTree parent0, double internalNodeProbability, SymbolicExpressionSearchSpace encoding, out CutPoint crossoverPoint)
  {
  ...
  public override SymbolicExpressionTree Cross(IParents<SymbolicExpressionTree> parents, IRandomNumberGenerator random, SymbolicExpressionSearchSpace encoding) => Cross(random, parents.Item1, parents.Item2, InternalCrossoverPointProbability, encoding);
}
