...
{
  public static ICrossover<TGenotype, TSearchSpace, TProblem> WithProbability<TGenotype, TSearchSpace, TProblem>(this ICrossover<TGenotype, TSearchSpace, TProblem> crossover, double probability)
    where TSearchSpace : class, ISearchSpace<TGenotype>
    where TProblem : class, IProblem<TGenotype, TSearchSpace> =>
    new MultiCrossover<TGenotype, TSearchSpace, TProblem>([crossover, NoCrossOver<TGenotype>.Instance], [probability, 1 - probability]);

  public static ICrossover<TGenotype, TSearchSpace> WithProbability<TGenotype, TSearchSpace>(this ICrossover<TGenotype, TSearchSpace> crossover, double probability)
    where TSearchSpace : class, ISearchSpace<TGenotype> =>
    new MultiCrossover<TGenotype, TSearchSpace>([crossover, NoCrossOver<TGenotype>.Instance], [probability, 1 - probability]);

  public static ICrossover<TGenotype> WithProbability<TGenotype>(this ICrossover<TGenotype> crossover, double probability) => new MultiCrossover<TGenotype>([crossover, NoCrossOver<TGenotype>.Instance], [probability, 1 - probability]);
}

public class MultiCrossover<TGenotype>(IReadOnlyList<ICrossover<TGenotype>> crossovers, IReadOnlyList<double>? weights = null)
  : MultiCrossover<TGenotype, ISearchSpace<TGenotype>>(crossovers, weights), ICrossover<TGenotype>
{
...
public class MultiCrossover<TGenotype, TSearchSpace>(IReadOnlyList<ICrossover<TGenotype, TSearchSpace>> crossovers, IReadOnlyList<double>? weights = null)
  : MultiCrossover<TGenotype, TSearchSpace, IProblem<TGenotype, TSearchSpace>>(crossovers, weights), ICrossover<TGenotype, TSearchSpace>
  where TSearchSpace : class, ISearchSpace<TGenotype>
{
  public IReadOnlyList<TGenotype> Cross(IReadOnlyList<IParents<TGenotype>> parents, IRandomNumberGenerator random, TSearchSpace encoding) => Cross(parents, random, encoding, null!);
}
  ...
  where TProblem : class, IProblem<TGenotype, TSearchSpace>
{
  ...
  public override IReadOnlyList<TGenotype> Cross(IReadOnlyList<IParents<TGenotype>> parents, IRandomNumberGenerator random, TSearchSpace encoding, TProblem problem)
  {
