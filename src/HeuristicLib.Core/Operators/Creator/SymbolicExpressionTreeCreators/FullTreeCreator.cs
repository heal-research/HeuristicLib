...
public class FullTreeCreator : SymbolicExpressionTreeCreator {
  ...
  public static void Create(IRandomNumberGenerator random, SymbolicExpressionTreeNode seedNode, SymbolicExpressionSearchSpace encoding, int maxDepth) {
  ...
  private static void RecursiveCreate(IRandomNumberGenerator random, SymbolicExpressionTreeNode root, SymbolicExpressionSearchSpace encoding, int currentDepth, int maxDepth, List<Symbol> allowedSymbols) {
