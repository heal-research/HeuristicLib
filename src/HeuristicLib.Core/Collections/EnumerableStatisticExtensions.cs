...
public static class EnumerableStatisticExtensions
{
  ...
  /// <param name="values"></param>
  /// <returns></returns>
  public static double StandardDeviation(this IEnumerable<double> values) => Math.Sqrt(values.Variance());
  ...
  /// <param name="values"></param>
  /// <returns></returns>
  public static double StandardDeviationPop(this IEnumerable<double> values) => Math.Sqrt(values.VariancePop());
  ...
  /// <param name="values"></param>
  /// <returns></returns>
  public static double Variance(this IEnumerable<double> values) => Variance(values, true);
  ...
  /// <param name="values"></param>
  /// <returns></returns>
  public static double VariancePop(this IEnumerable<double> values) => Variance(values, false);
