...
public interface ISymbolicExpressionGrammar : ISymbolicExpressionGrammarBase
{
  ...
  Genotypes.Trees.SymbolicExpressionTree MakeStump(IRandomNumberGenerator random)
  {
  ...
  void AddFullyConnectedSymbols(Symbol root, params ICollection<Symbol> symbols)
  {
