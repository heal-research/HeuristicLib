...
public class AlpsGeneticAlgorithm<TGenotype, TSearchSpace>(
  ...
  int elites,
  int randomSeed,
  ITerminator<TGenotype, AlpsAlgorithmState<TGenotype>, TSearchSpace, IProblem<TGenotype, TSearchSpace>> terminator,
  IInterceptor<TGenotype, AlpsAlgorithmState<TGenotype>, TSearchSpace, IProblem<TGenotype, TSearchSpace>>? interceptor = null)
...
public class AlpsGeneticAlgorithm<TGenotype>(
  ...
  int elites,
  int randomSeed,
  ITerminator<TGenotype, AlpsAlgorithmState<TGenotype>, ISearchSpace<TGenotype>, IProblem<TGenotype, ISearchSpace<TGenotype>>> terminator,
  IInterceptor<TGenotype, AlpsAlgorithmState<TGenotype>, ISearchSpace<TGenotype>, IProblem<TGenotype, ISearchSpace<TGenotype>>>? interceptor = null)
