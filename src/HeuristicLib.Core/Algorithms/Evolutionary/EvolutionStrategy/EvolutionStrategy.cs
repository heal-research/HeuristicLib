...
public class EvolutionStrategy<TGenotype, TEncoding, TProblem>
  : IterativeAlgorithm<TGenotype, TEncoding, TProblem, EvolutionStrategyAlgorithmState<TGenotype>>
  ...
  public override EvolutionStrategyAlgorithmState<TGenotype> ExecuteStep(TProblem problem, TEncoding searchSpace, EvolutionStrategyAlgorithmState<TGenotype>? previousIterationResult, IRandomNumberGenerator random) {
  ...
  public class Builder : PopulationBasedAlgorithmBuilder<
                           TGenotype, TEncoding, TProblem, EvolutionStrategyAlgorithmState<TGenotype>,
