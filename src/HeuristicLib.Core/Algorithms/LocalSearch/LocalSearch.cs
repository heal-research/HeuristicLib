...
public class LocalSearch<TGenotype, TEncoding, TProblem>
  : IterativeAlgorithm<TGenotype, TEncoding, TProblem, SingleISolutionAlgorithmState<TGenotype>>
  ...
  public class Builder : AlgorithmBuilder<TGenotype, TEncoding, TProblem, SingleISolutionAlgorithmState<TGenotype>, LocalSearch<TGenotype, TEncoding, TProblem>>, IMutatorPrototype<TGenotype, TEncoding, TProblem> {
