  ...
  where TR : class, IAlgorithmState 
{
  ...
  public ObservationPipeline(params IEnumerable<IIterationObserver<TG, TS, TP, TR>> observers) {
...
public static class ObservationPipeline {
  public static ObservationPipeline<TG, TS, TP, TR> Create<TG, TS, TP, TR>(params IEnumerable<IIterationObserver<TG, TS, TP, TR>> observers)
    where TG : class
    where TS : class, ISearchSpace<TG>
    where TP : class, IProblem<TG, TS>
    where TR : class, IAlgorithmState 
  {
    return new ObservationPipeline<TG, TS, TP, TR>(observers);
  }
}
