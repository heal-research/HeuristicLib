...
public static class BBoBSuite {
  ...
  private static SphereFunction CreateSphereProblem(int function, int dimension, int instance, long randomSeed) {
    return new SphereFunction { Dimension = dimension };
  }

  private static EllipsoidFunction CreateEllipsoidProblem(int function, int dimension, int instance, long randomSeed) {
    return new EllipsoidFunction { Dimension = dimension };
  }

  private static RastriginFunction CreateRastriginProblem(int function, int dimension, int instance, long randomSeed) {
    return new RastriginFunction { Dimension = dimension };
  }

  private static BuecheRastriginFunction CreateBuecheRastriginProblem(int function, int dimension, int instance, long randomSeed3) {
    return new BuecheRastriginFunction { Dimension = dimension };
  }

  private static LinearSlopeFunction CreateLinearSlopeProblem(int function, int dimension, int instance, long randomSeed) {
  ...
  private static DiscusFunction CreateDiscusProblem(int function, int dimension, int instance, long randomSeed) {
    return new DiscusFunction { Dimension = dimension };
  }

  private static BentCigarFunction CreateBentCigarProblem(int function, int dimension, int instance, long randomSeed) {
    return new BentCigarFunction { Dimension = dimension };
  }

  private static SharpRidgeFunction CreateSharpRidgeProblem(int function, int dimension, int instance, long randomSeed) {
    return new SharpRidgeFunction { Dimension = dimension };
  }

  private static DifferentPowersFunction CreateDifferentPowersProblem(int function, int dimension, int instance, long randomSeed) {
  ...
  private static GriewankRosenbrockFunction CreateGriewankRosenbrockProblem(int function, int dimension, int instance, long randomSeed) {
    return new GriewankRosenbrockFunction { Dimension = dimension };
  }

  private static SchwefelFunction CreateSchwefelProblem(int function, int dimension, int instance, long randomSeed) {
  ...
  private static KatsuuraFunction CreateKatsuuraProblem(int function, int dimension, int instance, long randomSeed) {
