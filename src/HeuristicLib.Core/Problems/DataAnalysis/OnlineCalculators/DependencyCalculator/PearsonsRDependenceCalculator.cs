...
public class PearsonsRDependenceCalculator : IDependencyCalculator
{
  ...
  public double Calculate(IEnumerable<double> originalValues, IEnumerable<double> estimatedValues, out OnlineCalculatorError errorState) => OnlinePearsonsRCalculator.Calculate(originalValues, estimatedValues, out errorState);
