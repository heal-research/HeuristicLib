...
public sealed class SymbolicDataAnalysisExpressionExcelFormatter : ISymbolicExpressionTreeStringFormatter {
  ...
  public string Format(SymbolicExpressionTree symbolicExpressionTree, Dataset? dataset) {
    return FormatWithMapping(symbolicExpressionTree, dataset != null ? CalculateVariableMapping(symbolicExpressionTree, dataset) : new Dictionary<string, string>());
  }
  ...
  public string FormatWithMapping(SymbolicExpressionTree symbolicExpressionTree, Dictionary<string, string> customVariableNameMapping) {
    foreach (var kvp in customVariableNameMapping) this.variableNameMapping.Add(kvp.Key, kvp.Value);
