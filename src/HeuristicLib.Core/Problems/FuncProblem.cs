...
{
  public static FuncProblem<TGenotype, TSearchSpace> Create<TGenotype, TSearchSpace>(Func<TGenotype, double> evaluateFunc, TSearchSpace searchSpace, Objective objective) where TSearchSpace : class, ISearchSpace<TGenotype> => new(evaluateFunc, searchSpace, objective);
}
