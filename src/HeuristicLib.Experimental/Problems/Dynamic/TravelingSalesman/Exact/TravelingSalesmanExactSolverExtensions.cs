...
{
    public static TravelingSalesmanExactSolution Solve(this ITravelingSalesmanExactSolver solver, ActivatedTravelingSalesmanProblem problem, CancellationToken cancellationToken = default) =>
