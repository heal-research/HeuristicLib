...
using ErfSymbol = HEAL.HeuristicLib.Encodings.LegacySymbolicExpressions.Erf;
using NormSymbol = HEAL.HeuristicLib.Encodings.LegacySymbolicExpressions.Norm;
using Variable = HEAL.HeuristicLib.Encodings.LegacySymbolicExpressions.Variable;
