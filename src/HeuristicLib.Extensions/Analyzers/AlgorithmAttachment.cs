...

{
  ...
  public virtual ITerminator<T1, TRes1, TS1, TP1> WrapTerminator<T1, TRes1, TS1, TP1>(ITerminator<T1, TRes1, TS1, TP1> terminator) 
    where T1 : class, TG
    where TRes1 : class, IAlgorithmState, TRes
    where TS1 : class, ISearchSpace<T1>, TS
    where TP1 : class, IProblem<T1, TS1>, TP => terminator;
  
  public virtual IEvaluator<T1, TS1, TP1> WrapEvaluator<T1, TS1, TP1>(IEvaluator<T1, TS1, TP1> evaluator) 
    where T1 : class, TG
    where TS1 : class, ISearchSpace<T1>, TS
    where TP1 : class, IProblem<T1, TS1>, TP => evaluator;
  
  public virtual IMutator<T1, TS1, TP1> WrapMutator<T1, TS1, TP1>(IMutator<T1, TS1, TP1> mutator)
    where T1 : class, TG
    where TS1 : class, ISearchSpace<T1>, TS
    where TP1 : class, IProblem<T1, TS1>, TP => mutator;
  
  public virtual ICrossover<T1, TS1, TP1> WrapCrossover<T1, TS1, TP1>(ICrossover<T1, TS1, TP1> crossover)
    where T1 : class, TG
    where TS1 : class, ISearchSpace<T1>, TS
    where TP1 : class, IProblem<T1, TS1>, TP => crossover;
  
  public virtual ISelector<T1, TS1, TP1> WrapSelector<T1, TS1, TP1>(ISelector<T1, TS1, TP1> selector) 
    where T1 : class, TG
    where TS1 : class, ISearchSpace<T1>, TS
    where TP1 : class, IProblem<T1, TS1>, TP => selector;
  
  public virtual ICreator<T1, TS1, TP1> WrapCreator<T1, TS1, TP1>(ICreator<T1, TS1, TP1> creator) 
    where T1 : class, TG
    where TS1 : class, ISearchSpace<T1>, TS
