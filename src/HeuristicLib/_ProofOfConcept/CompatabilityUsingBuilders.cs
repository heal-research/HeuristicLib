...
public interface IAlgorithmBuilder<TGenotype, TEncoding>
  where TEncoding : IEncoding<TGenotype>
{
  IAlgorithm<TGenotype, TEncoding> Create();
  
  ICrossover<TGenotype, TEncoding>? Crossover { get; }
  
  IAlgorithmBuilder<TGenotype, TEncoding> WithCrossover(ICrossover crossover);
  IAlgorithmBuilder<TGenotype, TEncoding> WithCrossover(ICrossover<TGenotype, TEncoding> crossover);
...
public interface IAlgorithmBuilder<TGenotype, TEncoding, TProblem>
  where TEncoding : IEncoding<TGenotype>
  where TProblem : IProblem<TGenotype, TEncoding>
{
  IAlgorithm<TGenotype, TEncoding, TProblem> Create();
  
  ICrossover<TGenotype, TEncoding, TProblem>? Crossover { get; }
  
  IAlgorithmBuilder<TGenotype, TEncoding, TProblem> WithCrossover(ICrossover crossover);
  IAlgorithmBuilder<TGenotype, TEncoding, TProblem> WithCrossover(ICrossover<TGenotype, TEncoding> crossover);
  IAlgorithmBuilder<TGenotype, TEncoding, TProblem> WithCrossover(ICrossover<TGenotype, TEncoding, TProblem> crossover);
}
...
public class EncodingIndependentAlgorithmBuilder<TGenotype, TEncoding> : IAlgorithmBuilder<TGenotype, TEncoding>
  where TEncoding : IEncoding<TGenotype>
{
  public ICrossover<TGenotype, TEncoding>? Crossover { get; private set; }

  public IAlgorithm<TGenotype, TEncoding> Create() => new EncodingIndependentAlgorithm<TGenotype, TEncoding> { Crossover = Crossover };

  public IAlgorithmBuilder<TGenotype, TEncoding> WithCrossover(ICrossover crossover) {
    Crossover = new BaseCrossover.Adapter<TGenotype, TEncoding>(crossover);
    return this;
  }

  public IAlgorithmBuilder<TGenotype, TEncoding> WithCrossover(ICrossover<TGenotype, TEncoding> crossover) {
    Crossover = crossover;
    return this;
  }
}
...
public class EncodingIndependentAlgorithmBuilder<TGenotype, TEncoding, TProblem> : IAlgorithmBuilder<TGenotype, TEncoding, TProblem>
  where TEncoding : IEncoding<TGenotype>
  where TProblem : IProblem<TGenotype, TEncoding>
{
  public ICrossover<TGenotype, TEncoding, TProblem>? Crossover { get; private set; }

  public IAlgorithm<TGenotype, TEncoding, TProblem> Create() => new EncodingIndependentAlgorithm<TGenotype, TEncoding, TProblem> { Crossover = Crossover };

  public IAlgorithmBuilder<TGenotype, TEncoding, TProblem> WithCrossover(ICrossover crossover) {
    Crossover = new BaseCrossover.Adapter<TGenotype, TEncoding, TProblem>(crossover);
    return this;
  }

  public IAlgorithmBuilder<TGenotype, TEncoding, TProblem> WithCrossover(ICrossover<TGenotype, TEncoding> crossover) {
    Crossover = new BaseCrossover<TGenotype, TEncoding>.Adapter<TProblem>(crossover);
    return this;
  }

  public IAlgorithmBuilder<TGenotype, TEncoding, TProblem> WithCrossover(ICrossover<TGenotype, TEncoding, TProblem> crossover) {
    Crossover = crossover;
    return this;
  }
}
...
public class PermutationEncodingSpecificAlgorithmBuilder : IAlgorithmBuilder<Permutation, PermutationEncoding>
{
  public ICrossover<Permutation, PermutationEncoding>? Crossover { get; private set; }

  public IAlgorithm<Permutation, PermutationEncoding> Create() => new PermutationEncodingSpecificAlgorithm { Crossover = Crossover };

  public IAlgorithmBuilder<Permutation, PermutationEncoding> WithCrossover(ICrossover crossover) {
    Crossover = new BaseCrossover.Adapter<Permutation, PermutationEncoding>(crossover);
    return this;
  }

  public IAlgorithmBuilder<Permutation, PermutationEncoding> WithCrossover(ICrossover<Permutation, PermutationEncoding> crossover) {
    Crossover = crossover;
    return this;
  }
}
...
public class TravelingSalesmanProblemSpecificAlgorithmBuilder : IAlgorithmBuilder<Permutation, PermutationEncoding, TravelingSalesmanProblem>
{
  public ICrossover<Permutation, PermutationEncoding, TravelingSalesmanProblem>? Crossover { get; private set; }

  public IAlgorithm<Permutation, PermutationEncoding, TravelingSalesmanProblem> Create() => new TravelingSalesmanProblemSpecificAlgorithm { Crossover = Crossover };

  public IAlgorithmBuilder<Permutation, PermutationEncoding, TravelingSalesmanProblem> WithCrossover(ICrossover crossover) {
    Crossover = new BaseCrossover.Adapter<Permutation, PermutationEncoding, TravelingSalesmanProblem>(crossover);
    return this;
  }

  public IAlgorithmBuilder<Permutation, PermutationEncoding, TravelingSalesmanProblem> WithCrossover(ICrossover<Permutation, PermutationEncoding> crossover) {
    Crossover = new BaseCrossover<Permutation, PermutationEncoding>.Adapter<TravelingSalesmanProblem>(crossover);
    return this;
  }

  public IAlgorithmBuilder<Permutation, PermutationEncoding, TravelingSalesmanProblem> WithCrossover(ICrossover<Permutation, PermutationEncoding, TravelingSalesmanProblem> crossover) {
    Crossover = crossover;
    return this;
  }
}
...
public class RealVectorEncodingSpecificAlgorithmBuilder : IAlgorithmBuilder<RealVector, RealVectorEncoding>
{
  public ICrossover<RealVector, RealVectorEncoding>? Crossover { get; private set; }

  public IAlgorithm<RealVector, RealVectorEncoding> Create() => new RealVectorEncodingSpecificAlgorithm { Crossover = Crossover };

  public IAlgorithmBuilder<RealVector, RealVectorEncoding> WithCrossover(ICrossover crossover) {
    Crossover = new BaseCrossover.Adapter<RealVector, RealVectorEncoding>(crossover);
    return this;
  }

  public IAlgorithmBuilder<RealVector, RealVectorEncoding> WithCrossover(ICrossover<RealVector, RealVectorEncoding> crossover) {
    Crossover = crossover;
    return this;
  }
}
...
public class TestFunctionProblemSpecificAlgorithmBuilder : IAlgorithmBuilder<RealVector, RealVectorEncoding, TestFunctionProblem>
{
  public ICrossover<RealVector, RealVectorEncoding, TestFunctionProblem>? Crossover { get; private set; }

  public IAlgorithm<RealVector, RealVectorEncoding, TestFunctionProblem> Create() => new TestFunctionProblemSpecificAlgorithm { Crossover = Crossover };

  public IAlgorithmBuilder<RealVector, RealVectorEncoding, TestFunctionProblem> WithCrossover(ICrossover crossover) {
    Crossover = new BaseCrossover.Adapter<RealVector, RealVectorEncoding, TestFunctionProblem>(crossover);
    return this;
  }

  public IAlgorithmBuilder<RealVector, RealVectorEncoding, TestFunctionProblem> WithCrossover(ICrossover<RealVector, RealVectorEncoding> crossover) {
    Crossover = new BaseCrossover<RealVector, RealVectorEncoding>.Adapter<TestFunctionProblem>(crossover);
    return this;
  }

  public IAlgorithmBuilder<RealVector, RealVectorEncoding, TestFunctionProblem> WithCrossover(ICrossover<RealVector, RealVectorEncoding, TestFunctionProblem> crossover) {
    Crossover = crossover;
    return this;
  }
}
