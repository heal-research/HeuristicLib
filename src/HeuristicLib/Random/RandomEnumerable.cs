...
public static class RandomEnumerable {
  ...
  extension<T>(IEnumerable<T> source) {
    ...
    public T SampleProportional(IRandomNumberGenerator random, IEnumerable<double> weights) {
      return source.SampleProportional(random, weights, false, false).First();
    }

    public T SampleProportional(IEnumerable<double> weights, IRandomNumberGenerator random) {
    ...
    public IEnumerable<T> SampleProportional(IRandomNumberGenerator random, int count, IEnumerable<double> weights, bool windowing = true, bool inverseProportional = false) {
