...
public class UniformRealDistribution(double low, double high) : IDistribution<double> {
  public UniformRealDistribution(double high) : this(0.0, high) { }
  public UniformRealDistribution() : this(0.0, 1.0) { }
...
public class UniformIntegerDistribution(int low, int high, bool inclusiveHigh = false) : IDistribution<int> {
  public UniformIntegerDistribution(int high, bool inclusiveHigh = false) : this(0, high, inclusiveHigh) { }
  public UniformIntegerDistribution() : this(0, 1, false) { }
  
  public int Sample(IRandomNumberGenerator rng) {
