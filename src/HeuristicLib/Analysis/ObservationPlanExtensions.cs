...
public static class ObservationPlanExtensions
{
    extension(ObservationPlan observations)
    {
        ...
        public void Observe<TG, TS, TP>(IReplacer<TG, TS, TP> replacer, Action<IReadOnlyList<EvaluatedCandidate<TG>>, IReadOnlyList<EvaluatedCandidate<TG>>, IReadOnlyList<EvaluatedCandidate<TG>>, ObjectiveDirections, TS, TP> afterReplacement)
          where TS : class, ISearchSpace<TG>
          where TP : class, IProblem<TG, TS>
        ...
        public void Observe<TG, TS, TP>(ISelector<TG, TS, TP> selector, Action<IReadOnlyList<EvaluatedCandidate<TG>>, IReadOnlyList<EvaluatedCandidate<TG>>, ObjectiveDirections, int, TS, TP> afterSelection)
          where TS : class, ISearchSpace<TG>
          where TP : class, IProblem<TG, TS>
