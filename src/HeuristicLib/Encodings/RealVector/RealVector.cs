...
namespace HEAL.HeuristicLib.Encodings.RealVector;
...
public sealed class RealVector(params IEnumerable<double> elements) : IReadOnlyList<double>, IEquatable<RealVector> {
  ...
  public override bool Equals(object? obj) {
    ...
    if (ReferenceEquals(this, obj))
      return true;
    return obj is Permutation.Permutation other && Equals(other);
  }
  ...
  public static BoolVector.BoolVector operator >(RealVector a, RealVector b) {
    ...
    return new BoolVector.BoolVector(result);
  }
