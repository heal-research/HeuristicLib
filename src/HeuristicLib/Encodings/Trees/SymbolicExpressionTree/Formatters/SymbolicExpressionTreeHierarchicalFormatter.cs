...
namespace HEAL.HeuristicLib.Encodings.Trees.SymbolicExpressionTree.Formatters;
...
public sealed class SymbolicExpressionTreeHierarchicalFormatter : ISymbolicExpressionTreeStringFormatter {
  ...
  private static void RenderTree(TextWriter writer, Genotypes.Trees.SymbolicExpressionTree tree) {
