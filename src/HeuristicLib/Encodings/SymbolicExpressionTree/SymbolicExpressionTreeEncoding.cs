...
namespace HEAL.HeuristicLib.Encodings.SymbolicExpressionTree {
  [Item(nameof(SymbolicExpressionTreeEncoding), "Describes a symbolic expression tree encoding.")]
  ...
  public sealed class SymbolicExpressionTreeEncoding : Encoding<ISymbolicExpressionTreeCreator> {
    ...
    [Storable] private IFixedValueParameter<IntValue> treeLengthParameter;
    public IFixedValueParameter<IntValue> TreeLengthParameter {
      get => treeLengthParameter;
      set {
        if (value == null)
          throw new ArgumentNullException("Tree length parameter must not be null.");
        if (value.Value == null)
          throw new ArgumentNullException("Tree length parameter value must not be null.");
        if (treeLengthParameter == value)
          return;
    ...
    [Storable] private IFixedValueParameter<IntValue> treeDepthParameter;
    public IFixedValueParameter<IntValue> TreeDepthParameter {
      get => treeDepthParameter;
      set {
        if (value == null)
          throw new ArgumentNullException("Tree length parameter must not be null.");
        if (value.Value == null)
          throw new ArgumentNullException("Tree length parameter value must not be null.");
        if (treeDepthParameter == value)
          return;
    ...
    [Storable] private IValueParameter<ISymbolicExpressionGrammar> grammarParameter;
    public IValueParameter<ISymbolicExpressionGrammar> GrammarParameter {
      get => grammarParameter;
      set {
        if (value == null)
          throw new ArgumentNullException("Grammar parameter must not be null.");
        if (value.Value == null)
          throw new ArgumentNullException("Grammar parameter value must not be null.");
        if (grammarParameter == value)
          return;
    ...
    [Storable] private IFixedValueParameter<IntValue> functionDefinitionsParameter;
    public IFixedValueParameter<IntValue> FunctionDefinitionsParameter {
      get => functionDefinitionsParameter;
      set {
        if (value == null)
          throw new ArgumentNullException("Function definitions parameter must not be null.");
        if (value.Value == null)
          throw new ArgumentNullException("Function definitions parameter value must not be null.");
        if (functionDefinitionsParameter == value)
          return;
    ...
    [Storable] private IFixedValueParameter<IntValue> functionArgumentsParameter;
    public IFixedValueParameter<IntValue> FunctionArgumentsParameter {
      get => functionArgumentsParameter;
      set {
        if (value == null)
          throw new ArgumentNullException("Function arguments parameter must not be null.");
        if (value.Value == null)
          throw new ArgumentNullException("Function arguments parameter value must not be null.");
        if (functionArgumentsParameter == value)
          return;
    ...
    public int TreeLength {
      get => TreeLengthParameter.Value.Value;
      set => TreeLengthParameter.Value.Value = value;
    }

    public int TreeDepth {
      get => TreeDepthParameter.Value.Value;
    ...
    public int FunctionDefinitions {
      get => FunctionDefinitionsParameter.Value.Value;
      set => FunctionDefinitionsParameter.Value.Value = value;
    }

    public int FunctionArguments {
      get => FunctionArgumentsParameter.Value.Value;
    ...
    public SymbolicExpressionTreeEncoding(ISymbolicExpressionGrammar grammar) : this(nameof(SymbolicExpressionTree), grammar, 50, 50) { }
    public SymbolicExpressionTreeEncoding(ISymbolicExpressionGrammar grammar, int maximumLength, int maximumDepth) : this(nameof(SymbolicExpressionTree), grammar, maximumLength, maximumDepth) { }
    ...
    public override IEncoding Duplicate(string duplicateName) {
      return new SymbolicExpressionTreeEncoding(duplicateName, Grammar, TreeDepth, TreeLength);
    }
