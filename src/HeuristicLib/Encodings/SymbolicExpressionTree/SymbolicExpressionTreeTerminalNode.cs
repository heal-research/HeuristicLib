...
namespace HeuristicLab.Encodings.SymbolicExpressionTreeEncoding {
  ...
  public abstract class SymbolicExpressionTreeTerminalNode : SymbolicExpressionTreeNode {
    public override IEnumerable<ISymbolicExpressionTreeNode> Subtrees => Enumerable.Empty<ISymbolicExpressionTreeNode>();
    ...
    protected SymbolicExpressionTreeTerminalNode() { }
