...
namespace HeuristicLab.Encodings.SymbolicExpressionTreeEncoding {
  ...
  [Item(nameof(SimpleSymbol), "Represents a symbol that is identified by its name.")]
  [NonDiscoverableType]
  public sealed class SimpleSymbol : Symbol {
    [Storable] private readonly int minimumArity;
    [Storable] private readonly int maximumArity = byte.MaxValue;
