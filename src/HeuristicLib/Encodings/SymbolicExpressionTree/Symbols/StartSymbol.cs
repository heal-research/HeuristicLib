...
namespace HeuristicLab.Encodings.SymbolicExpressionTreeEncoding {
  ...
  [Item(StartSymbolName, StartSymbolDescription)]
  public sealed class StartSymbol : Symbol, IReadOnlySymbol {
    public const string StartSymbolName = nameof(StartSymbol);
    ...
    public StartSymbol() : base(StartSymbolName, StartSymbolDescription) { }
