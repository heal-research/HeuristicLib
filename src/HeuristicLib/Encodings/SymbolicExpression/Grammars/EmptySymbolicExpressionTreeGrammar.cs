...
namespace HEAL.HeuristicLib.Encodings.Grammars {
  internal sealed class EmptySymbolicExpressionTreeGrammar : ISymbolicExpressionTreeGrammar {
    ...
    internal EmptySymbolicExpressionTreeGrammar(ISymbolicExpressionGrammar grammar) {
      this.grammar = grammar ?? throw new ArgumentNullException();
    }
    ...
    public IEnumerable<Symbol> ModifiableSymbols => [];
    public bool IsModifiableSymbol(Symbol symbol) => throw new NotImplementedException();
  }
}
