...
public static class SelectorCounterExtensions
{
        ...
        where TProblem : class, IProblem<TCandidate, TSearchSpace>
    {
        ...
        public ISelector<TCandidate, TSearchSpace, TProblem> CountSelectedSolutions(ObservationCounter counter)
            => selector.ObserveWith(selected => counter.IncrementBy(selected.Count));

        public ISelector<TCandidate, TSearchSpace, TProblem> CountSelectedSolutions(out ObservationCounter counter)
        {
            counter = new ObservationCounter();
