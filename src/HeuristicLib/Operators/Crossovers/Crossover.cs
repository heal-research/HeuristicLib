...
{
    protected abstract ICrossoverInstance<TCandidate, TSearchSpace, TProblem> CreateCrossoverInstance(IExecutionInstanceResolver resolver);
...
public abstract record Crossover<TCandidate, TSearchSpace>
    ...
    where TSearchSpace : class, ISearchSpace<TCandidate>
{
    protected abstract ICrossoverInstance<TCandidate, TSearchSpace, IProblem<TCandidate, TSearchSpace>> CreateCrossoverInstance(IExecutionInstanceResolver resolver);
...
{
    protected abstract ICrossoverInstance<TCandidate, ISearchSpace<TCandidate>, IProblem<TCandidate, ISearchSpace<TCandidate>>> CreateCrossoverInstance(IExecutionInstanceResolver resolver);
