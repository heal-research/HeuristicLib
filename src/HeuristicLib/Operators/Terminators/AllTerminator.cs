...
public class AllTerminator<TGenotype, TIterationState, TSearchSpace, TProblem>(params IReadOnlyList<ITerminator<TGenotype, TIterationState, TSearchSpace, TProblem>> terminators)
