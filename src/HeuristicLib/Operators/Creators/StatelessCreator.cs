...
{
    protected sealed override ICreatorInstance<TCandidate, TSearchSpace, TProblem> CreateCreatorInstance(IExecutionInstanceResolver resolver) => this;
...
public abstract record StatelessCreator<TCandidate, TSearchSpace>
    ...
    where TSearchSpace : class, ISearchSpace<TCandidate>
{
    protected sealed override ICreatorInstance<TCandidate, TSearchSpace, IProblem<TCandidate, TSearchSpace>> CreateCreatorInstance(IExecutionInstanceResolver resolver) => this;
...
{
    protected sealed override ICreatorInstance<TCandidate, ISearchSpace<TCandidate>, IProblem<TCandidate, ISearchSpace<TCandidate>>> CreateCreatorInstance(IExecutionInstanceResolver resolver) => this;
