...
public static class MultiInterceptor {
  public static MultiInterceptor<TGenotype, TIterationResult, TEncoding, TProblem> Build<TGenotype, TIterationResult, TEncoding, TProblem>(IEnumerable<IInterceptor<TGenotype, TIterationResult, TEncoding, TProblem>> interceptors) where TIterationResult : IIterationResult<TGenotype> where TEncoding : class, IEncoding<TGenotype> where TProblem : class, IProblem<TGenotype, TEncoding> {
    return new MultiInterceptor<TGenotype, TIterationResult, TEncoding, TProblem>(interceptors);
  }
}

public class MultiInterceptor<TGenotype, TIterationResult, TEncoding, TProblem>(IEnumerable<IInterceptor<TGenotype, TIterationResult, TEncoding, TProblem>> interceptors) : Interceptor<TGenotype, TIterationResult, TEncoding, TProblem> where TIterationResult : IIterationResult<TGenotype> where TEncoding : class, IEncoding<TGenotype> where TProblem : class, IProblem<TGenotype, TEncoding> {
