...
public class ThresholdTerminator<TState> 
  : ITerminator<TState>
{
...
public class PauseTokenTerminator<TState>
  : ITerminator<TState>
{
...
public class AnyTerminator<TState>
  : ITerminator<TState>
{
  ...
  private readonly IReadOnlyList<ITerminator<TState>> criteria;
