...
{
  IExecutorExecution<TGenotype, TSearchSpace, TProblem, TAlgorithmState, TAlgorithm> CreateExecution();
}

public interface IExecutorExecution<TGenotype, in TSearchSpace, in TProblem, TAlgorithmState, TAlgorithm>
  where TGenotype : class
  where TSearchSpace : class, ISearchSpace<TGenotype>
  where TProblem : class, IProblem<TGenotype, TSearchSpace>
  where TAlgorithmState : class, IAlgorithmState
